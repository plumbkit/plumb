...
func (s *connSession) registerAllTools(srv *mcp.Server, daemonStartedAt time.Time) {
	srv.Register(tools.NewFindSymbol(s.sessionProxy, s.sessionCache, s.ttl))
	srv.Register(tools.NewWorkspaceSymbols(s.sessionProxy, s.sessionCache, s.ttl, s.workspace))
	srv.Register(tools.NewGetDefinition(s.sessionProxy, s.sessionCache, s.ttl))
	srv.Register(tools.NewExplainSymbol(s.sessionProxy, s.sessionCache, s.ttl))
	srv.Register(tools.NewListSymbols(s.sessionProxy, s.sessionCache, s.ttl))
	...
	srv.Register(tools.NewReadSymbol(s.sessionProxy, s.sessionCache, s.ttl, s.readTracker))
	...
	srv.Register(tools.NewRenameSymbol(s.sessionProxy))
	srv.Register(tools.NewInsertBeforeSymbol(s.sessionProxy))
	srv.Register(tools.NewInsertAfterSymbol(s.sessionProxy))
	srv.Register(tools.NewReplaceSymbolBody(s.sessionProxy))
	srv.Register(tools.NewSafeDeleteSymbol(s.sessionProxy))
