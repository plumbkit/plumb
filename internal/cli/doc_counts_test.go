...
func TestLanguageAndClientSourceCountsPinned(t *testing.T) {
	const (
		wantLanguages = 23 // indexed languages; site shows 22 (.tsx folds into TypeScript), README says "15+"
		wantUncovered = 9  // langsupport rows recognised but not yet indexed — decreases as extractors land
