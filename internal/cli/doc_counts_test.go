...
func TestLanguageAndClientSourceCountsPinned(t *testing.T) {
	const (
		wantLanguages = 20 // indexed languages; site shows 18 (.tsx folds into TypeScript), README says "15+"
		wantUncovered = 12 // langsupport rows recognised but not yet indexed — decreases as extractors land
