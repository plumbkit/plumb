...
var settingTOMLPaths = map[settingKey][]string{
	...
	skGitWriteTimeout:      {"git", "write_timeout"},
	...
	skCollabAllowUnidentifiedWrites: {"collab", "allow_unidentified_writes"},
	...
	skCollabWakeWindowSec:           {"collab", "wake_window_seconds"},
	skCollabWakePeerWindowSec:       {"collab", "wake_peer_window_seconds"},
	skCollabKnowledgeHandoff:        {"collab", "knowledge_handoff"},
	skCollabIntentTTLMin:            {"collab", "intent_ttl_minutes"},
	skCollabNoteTTLMin:              {"collab", "note_ttl_minutes"},
	skCollabKeepDelivered:           {"collab", "keep_delivered_notes"},
