...
var initResult = protocol.InitializeResult{
	...
	ServerInfo: &protocol.ServerInfo{Name: "rust-analyzer", Version: "1.0.0"},
}

// newAdapter sets up a MockCaller with sensible defaults and returns the adapter.
func newAdapter(t *testing.T) (*rust.Adapter, *jsonrpc.MockCaller) {
	t.Helper()
...
func TestAdapter_Initialize(t *testing.T) {
	...
	result, err := ad.Initialize(ctx, rust.DefaultInitParams("file:///project"))
	if err != nil {
	...
	if result.ServerInfo == nil || result.ServerInfo.Name != "rust-analyzer" {
...
func TestAdapter_Initialized(t *testing.T) {
	...
	if _, err := ad.Initialize(ctx, rust.DefaultInitParams("file:///project")); err != nil {
		t.Fatal(err)
	}
...
func TestAdapter_DidChangeWatchedFiles(t *testing.T) {
	...
	if _, err := ad.Initialize(ctx, rust.DefaultInitParams("file:///p")); err != nil {
		t.Fatal(err)
	}
	err := ad.DidChangeWatchedFiles(ctx, protocol.DidChangeWatchedFilesParams{
		Changes: []protocol.FileEvent{
			{URI: "file:///p/src/lib.rs", Type: protocol.FileChanged},
			{URI: "file:///p/src/new.rs", Type: protocol.FileCreated},
		},
	})
	if err != nil {
...
func TestAdapter_DidOpenDidClose(t *testing.T) {
	...
	if err := ad.DidOpen(ctx, protocol.DidOpenTextDocumentParams{
		TextDocument: protocol.TextDocumentItem{
			URI: "file:///p/src/lib.rs", LanguageID: "rust", Version: 1, Text: "fn main() {}\n",
		},
	}); err != nil {
		t.Fatalf("DidOpen: %v", err)
	}
	if err := ad.DidClose(ctx, protocol.DidCloseTextDocumentParams{
		TextDocument: protocol.TextDocumentIdentifier{URI: "file:///p/src/lib.rs"},
	}); err != nil {
...
func TestAdapter_WorkspaceSymbols(t *testing.T) {
	...
	expected := []protocol.SymbolInformation{
		{Name: "Greeter", Kind: protocol.SKStruct, Location: protocol.Location{URI: "file:///p/src/lib.rs"}},
	}
...
func TestAdapter_Definition(t *testing.T) {
	...
	expected := []protocol.Location{
		{URI: "file:///p/src/lib.rs", Range: protocol.Range{Start: protocol.Position{Line: 3}}},
	}
...
func TestAdapter_References(t *testing.T) {
	...
	expected := []protocol.Location{
		{URI: "file:///p/src/lib.rs", Range: protocol.Range{Start: protocol.Position{Line: 10}}},
		{URI: "file:///p/src/lib.rs", Range: protocol.Range{Start: protocol.Position{Line: 14}}},
	}
...
func TestAdapter_Hover(t *testing.T) {
	...
	expected := protocol.Hover{
		Contents: protocol.MarkupContent{Kind: "markdown", Value: "```rust\nstruct Greeter\n```"},
	}
...
func TestAdapter_Rename(t *testing.T) {
	...
	if len(edit.Changes["file:///p/src/lib.rs"]) != 1 {
