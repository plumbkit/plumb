...
| **Search & navigation** (tree-sitter, no LSP needed) | 20+ incl. JS/TS/TSX, Ruby, C, JSON, Bash, SQL, HCL, Dockerfile, TOML, YAML, Markdown | Ranked symbol search, outlines, graph exploration via the Topology index |
