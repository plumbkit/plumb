...
| **Search & navigation** (tree-sitter, no LSP needed) | 29+ incl. JS/TS/TSX, Ruby, C, C#, PHP, JSON, CSS, SCSS, XML, Lua, C++, Objective-C, Dart, Bash, SQL, HCL, Dockerfile, TOML, YAML, Markdown | Ranked symbol search, outlines, graph exploration via the Topology index |
