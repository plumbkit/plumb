...
| **Search & navigation** (tree-sitter, no LSP needed) | 18+ incl. JS/TS/TSX, Ruby, Bash, SQL, HCL, Dockerfile, TOML, YAML, Markdown | Ranked symbol search, outlines, graph exploration via the Topology index |
