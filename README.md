...
| **Search & navigation** (tree-sitter, no LSP needed) | 27+ incl. JS/TS/TSX, Ruby, C, PHP, JSON, CSS, SCSS, XML, Lua, C++, Objective-C, Bash, SQL, HCL, Dockerfile, TOML, YAML, Markdown | Ranked symbol search, outlines, graph exploration via the Topology index |
