...
| **Search & navigation** (tree-sitter, no LSP needed) | 24+ incl. JS/TS/TSX, Ruby, C, PHP, JSON, CSS, SCSS, XML, Bash, SQL, HCL, Dockerfile, TOML, YAML, Markdown | Ranked symbol search, outlines, graph exploration via the Topology index |
