...
| **Search & navigation** (tree-sitter, no LSP needed) | 19+ incl. JS/TS/TSX, Ruby, C, Bash, SQL, HCL, Dockerfile, TOML, YAML, Markdown | Ranked symbol search, outlines, graph exploration via the Topology index |
