...
| **Search & navigation** (tree-sitter, no LSP needed) | 21+ incl. JS/TS/TSX, Ruby, C, JSON, CSS, Bash, SQL, HCL, Dockerfile, TOML, YAML, Markdown | Ranked symbol search, outlines, graph exploration via the Topology index |
