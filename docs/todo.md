...
| `(Model).popupRightAll` | ~~18~~ **done (0.7.1)** |
| `(Model).handleDashboardKey` | ~~17~~ **done (0.7.1)** |
| `(*Model).handleMouseWheel` | ~~17~~ **done (0.7.1)** |
| `(Model).leftLines` | ~~16~~ **done (0.7.1)** |
