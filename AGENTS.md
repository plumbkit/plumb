...
- **Other utilities:** `git_init`, `file_diff`, `daemon_info` (session, daemon version, Go runtime, OS/arch, config state), `rename_session`, `workspace_sessions`.
