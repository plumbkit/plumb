...
| `internal/lsp/adapters/{gopls,pyright,jdtls,rust}/` | Go (validated), Python (validated), Java (validated; experimental, `[lsp.java] enabled = true`), Rust (validated; opt-in, `[lsp.rust] enabled = true`) adapters |
