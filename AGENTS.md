...
- **LSP queries:** `find_symbol`, `workspace_symbols`, `get_definition`, `explain_symbol`, `file_outline`, `find_references`, `call_hierarchy`, `type_hierarchy`, `diagnostics`.
