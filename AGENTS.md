...
| `internal/topology/` | SQLite/FTS5 semantic graph; background indexer; Go AST, tree-sitter Python/Rust/Zig/Kotlin, and TypeScript/JS regex extractors; search + BFS explore/impact/affected/routes |
